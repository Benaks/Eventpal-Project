...
const Navbar = () => {
  ...
  const menuItems = ['Local events', 'Create events', 'Blog', 'Help center' ]
   return (
     <div className="text-black justify-between flex items-center  px-5 py-4 h-36 max-w-[1240px] mx-auto bg-[#faf4fa]">
       ...
       {/* This is wrong - loop these elements bro - this is not html */}
       ...
       {/* there is a button component bro  - don't  explicitely create a button, except required */}
